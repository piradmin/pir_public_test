...
// Init vars
$LOCAL_ROOT         = "/var/www/yourideahere.org/public_html/wp-content/themes/pir_public_test";
$LOCAL_REPO_NAME    = "pir_public_test";
$LOCAL_REPO         = "{$LOCAL_ROOT}/{$LOCAL_REPO_NAME}";
$REMOTE_REPO        = "git@github.com:piradmin/pir_public_test.git";
